...
class SpeedHistory(models.Model):
    speedtest_server = models.ForeignKey(
        Netvelocity, null=True, on_delete=models.SET_NULL
    )
    download = models.DecimalField(decimal_places=0, max_digits=65, null=True)
